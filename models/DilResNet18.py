...
class ResNet(nn.Module):
    def __init__(self, block_18, layers, in_channels, num_classes):
        ...
        self.in_channels = 64
        self.conv1 = nn.Conv2d(in_channels, 64, kernel_size=7, stride=2, padding=3)  # self.conv1 = GaborConv2d(in_channels, 64, kernel_size=7, stride=2, padding=3)
...
def DilResNet18(in_channels, num_classes=10):
