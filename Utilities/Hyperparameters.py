...
def arguments():
    ...
    parser.add_argument("--dataset", help="bw, edge, sobel, wet, dry, bw_wet, edge_wet, sobel_wet, bw_dry, edge_dry,"
                                          "sobel_dry")
    parser.add_argument("--architecture", default="cnn4", help="cnn2=CNN2, cnn4=CNN4, cnn5=CNN5, vgg11=VGG11, vgg13=VGG13, oldcnn3=OldCNN3"
                                                                    ...
                                                                    "gaborcnn=GaborCNN, gabormpcnn=GaborMPCNN, cnn5mixp=CNN5MixP")
